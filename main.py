...
import numpy as np
# import torch
from dino_agent import Agent
from dino_env import DinoEnvironment
# from dqn_memory import ReplayBuffer

# 학습의 흐름
# 1. 게임 시작과 동시에 학습 데이터 입력 - 게임 화면을 캡쳐한 이미지, 연속 동작임을 판단하기 위해 4장의 연속된 프레임 stacking
#   1) 눈(vision)
#       Numpy -> Tensor 변환, 2. 배치 차원 추가: (4, 84, 84) -> (1, 4, 84, 84)

#   2) 뇌(CNN + FC Layer)
# 3층의 CNN 으로 프레임스택의 특성 추출
